...
public class ControllerTask implements Runnable {
	...
	private void broadcastUpdateDisplayData ( Controller ra ) {
		Intent i = new Intent();
		i.putExtra( StatusTable.COL_T1, ra.getTemp1() );
		i.putExtra( StatusTable.COL_T2, ra.getTemp2() );
		i.putExtra( StatusTable.COL_T3, ra.getTemp3() );
		i.putExtra( StatusTable.COL_PH, ra.getPH() );
		i.putExtra( StatusTable.COL_DP, ra.getPwmD() );
		i.putExtra( StatusTable.COL_AP, ra.getPwmA() );
		i.putExtra( StatusTable.COL_SAL, ra.getSalinity() );
		i.putExtra( StatusTable.COL_ORP, ra.getORP() );
		i.putExtra( StatusTable.COL_ATOHI, ra.getAtoHigh() );
		i.putExtra( StatusTable.COL_ATOLO, ra.getAtoLow() );
		i.putExtra( StatusTable.COL_LOGDATE, ra.getLogDate() );
		i.putExtra( StatusTable.COL_RDATA, ra.getMainRelay().getRelayData() );
		i.putExtra( StatusTable.COL_RONMASK, ra.getMainRelay().getRelayOnMask() );
		i.putExtra( StatusTable.COL_ROFFMASK, ra.getMainRelay().getRelayOffMask() );
		i.putExtra( StatusTable.COL_R1DATA, ra.getExpRelay( 1 ).getRelayData() );
		i.putExtra( StatusTable.COL_R1ONMASK, ra.getExpRelay( 1 ).getRelayOnMask() );
		i.putExtra( StatusTable.COL_R1OFFMASK, ra.getExpRelay( 1 )
				.getRelayOffMask() );
		i.putExtra( StatusTable.COL_R2DATA, ra.getExpRelay( 2 ).getRelayData() );
		i.putExtra( StatusTable.COL_R2ONMASK, ra.getExpRelay( 2 ).getRelayOnMask() );
		i.putExtra( StatusTable.COL_R2OFFMASK, ra.getExpRelay( 2 )
				.getRelayOffMask() );
		i.putExtra( StatusTable.COL_R3DATA, ra.getExpRelay( 3 ).getRelayData() );
		i.putExtra( StatusTable.COL_R3ONMASK, ra.getExpRelay( 3 ).getRelayOnMask() );
		i.putExtra( StatusTable.COL_R3OFFMASK, ra.getExpRelay( 3 )
				.getRelayOffMask() );
		i.putExtra( StatusTable.COL_R4DATA, ra.getExpRelay( 4 ).getRelayData() );
		i.putExtra( StatusTable.COL_R4ONMASK, ra.getExpRelay( 4 ).getRelayOnMask() );
		i.putExtra( StatusTable.COL_R4OFFMASK, ra.getExpRelay( 4 )
				.getRelayOffMask() );
		i.putExtra( StatusTable.COL_R5DATA, ra.getExpRelay( 5 ).getRelayData() );
		i.putExtra( StatusTable.COL_R5ONMASK, ra.getExpRelay( 5 ).getRelayOnMask() );
		i.putExtra( StatusTable.COL_R5OFFMASK, ra.getExpRelay( 5 )
				.getRelayOffMask() );
		i.putExtra( StatusTable.COL_R6DATA, ra.getExpRelay( 6 ).getRelayData() );
		i.putExtra( StatusTable.COL_R6ONMASK, ra.getExpRelay( 6 ).getRelayOnMask() );
		i.putExtra( StatusTable.COL_R6OFFMASK, ra.getExpRelay( 6 )
				.getRelayOffMask() );
		i.putExtra( StatusTable.COL_R7DATA, ra.getExpRelay( 7 ).getRelayData() );
		i.putExtra( StatusTable.COL_R7ONMASK, ra.getExpRelay( 7 ).getRelayOnMask() );
		i.putExtra( StatusTable.COL_R7OFFMASK, ra.getExpRelay( 7 )
				.getRelayOffMask() );
		i.putExtra( StatusTable.COL_R8DATA, ra.getExpRelay( 8 ).getRelayData() );
		i.putExtra( StatusTable.COL_R8ONMASK, ra.getExpRelay( 8 ).getRelayOnMask() );
		i.putExtra( StatusTable.COL_R8OFFMASK, ra.getExpRelay( 8 )
				.getRelayOffMask() );
		i.putExtra( StatusTable.COL_PWME0, ra.getPwmExpansion( (short) 0 ) );
		i.putExtra( StatusTable.COL_PWME1, ra.getPwmExpansion( (short) 1 ) );
		i.putExtra( StatusTable.COL_PWME2, ra.getPwmExpansion( (short) 2 ) );
		i.putExtra( StatusTable.COL_PWME3, ra.getPwmExpansion( (short) 3 ) );
		i.putExtra( StatusTable.COL_PWME4, ra.getPwmExpansion( (short) 4 ) );
		i.putExtra( StatusTable.COL_PWME5, ra.getPwmExpansion( (short) 5 ) );
		i.putExtra( StatusTable.COL_AIW, ra.getAIChannel( Controller.AI_WHITE ) );
		i.putExtra( StatusTable.COL_AIB, ra.getAIChannel( Controller.AI_BLUE ) );
		i.putExtra( StatusTable.COL_AIRB, ra.getAIChannel( Controller.AI_ROYALBLUE ) );
		i.putExtra( StatusTable.COL_RFM,
					ra.getVortechValue( Controller.VORTECH_MODE ) );
		i.putExtra( StatusTable.COL_RFS,
					ra.getVortechValue( Controller.VORTECH_SPEED ) );
		i.putExtra( StatusTable.COL_RFD,
					ra.getVortechValue( Controller.VORTECH_DURATION ) );
		i.putExtra( StatusTable.COL_RFW,
					ra.getRadionChannel( Controller.RADION_WHITE ) );
		i.putExtra( StatusTable.COL_RFRB,
					ra.getRadionChannel( Controller.RADION_ROYALBLUE ) );
		i.putExtra( StatusTable.COL_RFR,
					ra.getRadionChannel( Controller.RADION_RED ) );
		i.putExtra( StatusTable.COL_RFG,
					ra.getRadionChannel( Controller.RADION_GREEN ) );
		i.putExtra( StatusTable.COL_RFB,
					ra.getRadionChannel( Controller.RADION_BLUE ) );
		i.putExtra( StatusTable.COL_RFI,
					ra.getRadionChannel( Controller.RADION_INTENSITY ) );
		i.putExtra( StatusTable.COL_IO, ra.getIOChannels() );
		i.putExtra( StatusTable.COL_C0, ra.getCustomVariable( (byte) 0 ) );
		i.putExtra( StatusTable.COL_C1, ra.getCustomVariable( (byte) 1 ) );
		i.putExtra( StatusTable.COL_C2, ra.getCustomVariable( (byte) 2 ) );
		i.putExtra( StatusTable.COL_C3, ra.getCustomVariable( (byte) 3 ) );
		i.putExtra( StatusTable.COL_C4, ra.getCustomVariable( (byte) 4 ) );
		i.putExtra( StatusTable.COL_C5, ra.getCustomVariable( (byte) 5 ) );
		i.putExtra( StatusTable.COL_C6, ra.getCustomVariable( (byte) 6 ) );
		i.putExtra( StatusTable.COL_C7, ra.getCustomVariable( (byte) 7 ) );
		i.putExtra( StatusTable.COL_EM, ra.getExpansionModules() );
		i.putExtra( StatusTable.COL_REM, ra.getRelayExpansionModules() );
		i.putExtra( StatusTable.COL_PHE, ra.getPHExp() );
		i.putExtra( StatusTable.COL_WL, ra.getWaterLevel() );
		rapp.insertData( i );
